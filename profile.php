...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="profile-card js-profile-card">
            <div class="profile-card__img">
                ...
                ?>
                <img src="uploads/<?php echo $result['picture'] ?>" alt="profile card">
            </div>

            <div class="profile-card__cnt js-profile-cnt">
                <div class="profile-card__name"> <?php echo $result['firstname'] ?></div>
                <div class="profile-card__txt"><strong>ชื่อ-นามสกุล</strong> <?php echo $result['firstname'] ?> <?php echo $result['lastname'] ?></div>
                <div class="profile-card__txt"><strong>Email</strong> <?php echo $result['email'] ?></div>
                ...
                <div class="profile-card-social">
                    <a href="https://www.facebook.com/omaewa.moga.shinderu" class="profile-card-social__item facebook" target="_blank">
                ...
                <div class="profile-card-ctr">
                    <button class="text-white profile-card__button button--blue js-message-btn" data-toggle="modal" data-target="#centralModalSm">แก้ไข</button>
                    <button class="profile-card__button button--orange">บันทึกข้อมูล</button>
                </div>
            </div>
    ...
    <!-- Central Modal Small -->
    <div class="modal fade" style="z-index: 100000" id="centralModalSm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-full-height modal-top" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header deep-purple lighten-1">
                    <h4 class="modal-title text-white w-100" id="myModalLabel">Update Profile</h4>
                    ...
                    <div class="container">
                        <div class="card mb-5">
                            <div class="card-body text-center">
                                ...
                                <form method="post" action="php/updatename.php?id=<?php echo $_SESSION['id'] ?>" enctype="multipart/form-data">

                                    <div class="form-group row">
                                        <figure class="figure mx-auto">
                                            <img src="uploads/<?php echo $result['picture'] ?>" id="imgUpload" style="width:350px;" class="rounded" alt="">
                                            <input type="hidden" name="hdnOldFile" value="<?php echo $result['picture']; ?>">
                                            <figcaption class="figure-caption">เลือกรูปสินค้า</figcaption>
                                        </figure>
                                    </div>

                                    <div class="form-group row">
                                        <label for="fileUpload" class="col-sm-2 col-form-label">รูปโปร์ไฟล์</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="p_name" class="col-sm-2 col-form-label">ชื่อ</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="p_name" class="col-sm-2 col-form-label">นามสกุล</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="username" class="col-sm-2 col-form-label">รหัสผ่าน</label>
                                        <div class="col-sm-10">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" name="update" id="update">Save changes</button>
                </div>
                </form>
            </div>
        </div>
