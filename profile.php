    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="profile-card js-profile-card">
                ...
                <img src="uploads/<?php echo $_SESSION['img'] ?>" alt="profile card">
                </div>

                <div class="profile-card__cnt js-profile-cnt">
                    <div class="profile-card__name"> <?php echo $_SESSION['name'] ?></div>
                    <div class="profile-card__txt"><strong>ชื่อ-นามสกุล</strong> <?php echo $_SESSION['name'] ?> <?php echo $_SESSION['lname'] ?></div>
                    <div class="profile-card__txt"><strong>Email</strong> <?php echo $_SESSION['email'] ?></div>
                    ...
                    <div class="profile-card-ctr">
                        <button class="profile-card__button button--blue js-message-btn">แก้ไข</button>
